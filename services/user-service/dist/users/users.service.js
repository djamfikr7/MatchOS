...
let UsersService = UsersService_1 = class UsersService {
    ...
    blockchainAdapterUrl = process.env.BLOCKCHAIN_ADAPTER_URL || 'http://localhost:3006';
    ...
    async mintReputationToken(userId, walletAddress) {
        ...
        try {
            const response = await axios_1.default.post(`${this.blockchainAdapterUrl}/reputation/mint`, {
